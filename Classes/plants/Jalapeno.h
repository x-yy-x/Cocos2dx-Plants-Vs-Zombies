...
class Jalapeno : public BombPlant
{
public:
    /**
     * @brief Jalapeno initialization function
     */
    virtual bool init() override;

    // Implement the auto-generated static Jalapeno* create() function
    CREATE_FUNC(Jalapeno);

    /**
     * @brief Static planting function for Jalapeno
     * @param globalPos Touch position in global coordinates
     * @return Jalapeno* Returns Jalapeno instance on success, nullptr on failure
     */
    static Jalapeno* plantAtPosition(const cocos2d::Vec2& globalPos);
